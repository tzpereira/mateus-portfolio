...
const projects: Project[] = [
  {
    ...
    intent: 'Engineering knowledge lives in docs and people’s heads. WEE turns well-defined workflows into versioned, replayable, budgeted pipelines — the engine owns the loops, not the model. Workflows are software; LLMs are an implementation detail.',
    decision: 'Hand-rolled net/http, zero vendor SDKs — control of the loop and budget over convenience.',
